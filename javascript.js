...
function createBoard(){
    ...
    return {gameBoard, checkWinner, resetBoard}
}
...
function domObject() {
    ...
    const createDivElement = () => {
        ...
        createdElement.textContent = "test";
    ...
    return {appendToDoc, createDivElement}
}
...
playerOne.chooseIndex(theBoard.gameBoard, 0, 0, playerOne);
playerOne.chooseIndex(theBoard.gameBoard, 1, 0, playerTwo);
playerOne.chooseIndex(theBoard.gameBoard, 2, 0, playerTwo);

playerOne.chooseIndex(theBoard.gameBoard, 0, 1, playerTwo);
playerOne.chooseIndex(theBoard.gameBoard, 1, 1, playerTwo);
playerOne.chooseIndex(theBoard.gameBoard, 2, 1, playerOne);

playerOne.chooseIndex(theBoard.gameBoard, 0, 2, playerOne);
playerOne.chooseIndex(theBoard.gameBoard, 1, 2, playerTwo);
playerOne.chooseIndex(theBoard.gameBoard, 2, 2, playerTwo);

playerOne.chooseIndex(theBoard.gameBoard, 1, 1, playerOne);

let theBoardContainer = theDom.createDivElement();
theDom.appendToDoc(document.body, theBoardContainer);
theBoardContainer.appendChild(theBoard);
